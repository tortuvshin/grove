...
- **`public/og/**`** — satori-rendered OG cards, namespaced by page type (`home.png`, `default.png`, `records/<slug>.png`, `collections/<slug>.png`, `categories/<id>.png`, `stacks/<id>.png`, `licenses/<id>.png`).
...
- The `Directory:` line in `llms.txt`.
