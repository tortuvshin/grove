...
<LinkButton href="/content/decisions/" variant="primary" icon="right-arrow">
  Build collections
</LinkButton>
...
<CardGrid>
  <LinkCard
    title="Decisions file"
    href="/content/decisions/"
    description="File shape and examples for data/decisions.yml."
  />
  ...
  <LinkCard
    title="Curation labels and lenses"
    href="/concepts/curation-labels/"
    description="How labels drive featured, hot, new, and mature lenses."
  />
</CardGrid>
