...
In practice this means: if you're on `0.6.1` and a new stable
release ships, you have 30 days of critical-only support on
`0.6.1` before you should upgrade. After 30 days, you're on
your own.
...
The list is empty in `0.6.1`; it is the right place to look if you
