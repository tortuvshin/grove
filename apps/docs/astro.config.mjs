...
export default defineConfig({
  ...
  integrations: [
    ...
    starlight({
      ...
      social: [{ icon: 'github', label: 'GitHub', href: 'https://github.com/tortuvshin/grove' }],
      head: [
        ...
        {
          tag: 'meta',
          attrs: { name: 'theme-color', media: '(prefers-color-scheme: dark)', content: '#0a0a0a' },
        },
        {
          tag: 'meta',
          attrs: {
        ...
        {
          tag: 'meta',
          attrs: { property: 'og:image', content: 'https://withgrove.dev/og-image.png' },
        },
        {
          tag: 'meta',
          attrs: { name: 'twitter:image', content: 'https://withgrove.dev/og-image.png' },
        },
