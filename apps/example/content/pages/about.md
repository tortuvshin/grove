...
1. `grove check` validates every record against the schema.
2. The Astro integration prepares generated data, sitemap, and LLM indexes.
3. `astro build` produces the static output without consumer prebuild scripts.
