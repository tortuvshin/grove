...
A version bump applies to all four packages in lockstep.

Entries from 0.10.0 onward are generated by release-please when the release
pull request merges; the Conventional Commit scope names the affected package,
so `feat(cli):` lands under `@grove-dev/cli`. Entries up to and including 0.9.0
were written by hand and call the packages out in **Packages** lines instead.
Unreleased work lives in the open release pull request, not in a section here.
...
## [0.10.0](https://github.com/tortuvshin/grove/compare/v0.9.0...v0.10.0) (2026-09-04)
...
- Repository tags use the form `vX.Y.Z` and are created by release-please
  when the release pull request merges. See
...
[0.9.0]: https://github.com/tortuvshin/grove/compare/v0.8.0...v0.9.0
[0.8.0]: https://github.com/tortuvshin/grove/compare/v0.7.0...v0.8.0
