...
const entries: CollectionEntry[] = [
  { slug: "a", title: "A", description: "Flutter", url: "/a/", stack: "flutter", platform: ["android"], status: "active", stars: 1500, curationScore: 0.9, activityScore: 0.9, pushedAt: "2026-06-01" },
  { slug: "b", title: "B", description: "Archived", url: "/b/", stack: "react-native", platform: ["ios"], status: "archived", stars: 200, curationScore: 0.5, activityScore: 0.1, pushedAt: "2024-01-01" },
  { slug: "c", title: "C", description: "Finance", url: "/c/", stack: "flutter", platform: ["android", "ios"], status: "active", stars: 50, curationScore: 0.7, activityScore: 0.9, pushedAt: "2025-12-01" },
];
...
describe("filterEntries", () => {
  ...
  it("excludes archived", () => {
    expect(filterEntries(entries, { excludeStatuses: ["archived"] }).map((e) => e.slug)).toEqual(["a", "c"]);
  });
