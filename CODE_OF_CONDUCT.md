...
This Code of Conduct applies within all community spaces — GitHub repository (issues, PRs, discussions, projects), documentation, release notes, the docs site, and any other channel the project uses for communication. It also applies when an individual is officially representing the community in public spaces (e.g. using an official project email address, posting via an official social media account, or acting as an appointed representative at an online or offline event).
...
We aim to acknowledge a report within **72 hours**, and to follow up with a resolution or status update within **7 days**.
